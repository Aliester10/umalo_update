...
namespace App\Http\Controllers\Distributor\Profile;
...
class DistributorProfileController extends Controller
{
    public function index()
    {
        ...
        return view('distributor.profile.index', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('profile_photo')) {
            ...
            // Save the new file in the 'public/distributor/profile' directory
