...
Route::group([
    'prefix' => LaravelLocalization::setLocale(),
    'middleware' => ['auth', 'user-access:member']
], function () {

    Route::get('/member/dashboard', [DashboardMemberController::class, 'index'])->name('member.dashboard');

    Route::post('/member/update-profile-photo', [DashboardMemberController::class, 'updateProfilePhoto'])
        ->name('member.updateProfilePhoto');
    ...
    Route::delete('/member/ticketing/{ticketId}/document/{documentIndex}', [MemberTicketingController::class, 'removeDocument'])
        ->name('member.ticketing.removeDocument');
    ...
    Route::get('/portal/monitoring/detail/{userProduct}', [PortalController::class, 'showInspeksiMaintenance'])
        ->name('portal.monitoring.detail');
});
...
Route::group([
    'prefix' => LaravelLocalization::setLocale(),
    'middleware' => ['auth', 'user-access:distributor']
], function () {

    Route::get('/distributor/dashboard', [DashboardDistributorController::class, 'index'])->name('distributor.dashboard');

    Route::post('/distributor/update-profile-photo', [DashboardDistributorController::class, 'updateProfilePhoto'])
        ->name('distributor.updateProfilePhoto');
    ...
    Route::get('/distributor/quotations/negotiation/create/{quotationId}', [DistributorQuotationNegotiationController::class, 'create'])
        ->name('distributor.quotations.negotiation.create');
    Route::post('/distributor/quotations/negotiation/store/{quotationId}', [DistributorQuotationNegotiationController::class, 'store'])
        ->name('distributor.quotations.negotiation.store');
    Route::get('/distributor/quotations/negotiation/show/{negotiationId}', [DistributorQuotationNegotiationController::class, 'show'])
        ->name('distributor.quotations.negotiation.show');

    Route::patch('quotations/negotiations/{negotiationId}/update-notes', [DistributorQuotationNegotiationController::class, 'updateDistributorNotes'])
        ->name('distributor.quotations.negotiations.updateNotes');

    // PURCHASE ORDER
    Route::get('/distributor/quotations/purchase-order/{id}', [DistributorPurchaseOrderController::class, 'create'])
        ->name('distributor.purchaseorder.create');
    Route::post('/distributor/quotations/purchase-order/{id}', [DistributorPurchaseOrderController::class, 'store'])
        ->name('distributor.purchaseorder.store');

    // PROFORMA INVOICE
    Route::get('/distributor/quotations/proforma-invoice/{id}', [DistributorProformaInvoiceController::class, 'index'])
        ->name('distributor.proformainvoice.index');
    Route::post('/distributor/proforma-invoices/{id}/payment-proof', [DistributorProformaInvoiceController::class, 'submitPaymentProof'])
        ->name('distributor.proforma.submitPaymentProof');
});
...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::group(['prefix' => LaravelLocalization::setLocale()], function () {
        ...
        Route::put('/admin/quotations/{id}', [AdminQuotationController::class, 'update'])->name('admin.quotations.update');
        Route::put('/admin/quotations/{id}/reject', [AdminQuotationController::class, 'reject'])->name('admin.quotations.reject');

        Route::get('/admin/quotations/negotiation/{negotiationId}', [AdminQuotationNegotiationController::class, 'show'])
            ->name('admin.quotations.negotiation.show');
        Route::put('/admin/quotations/negotiation/{negotiationId}', [AdminQuotationNegotiationController::class, 'update'])
            ->name('admin.quotations.negotiation.update');
        Route::put('quotations/negotiation/{negotiationId}/complete', [AdminQuotationNegotiationController::class, 'complete'])
            ->name('admin.quotations.negotiation.complete');

        // PURCHASE ORDER
        Route::get('admin/quotation/{id}/purchase-orders', [AdminPurchaseOrderController::class, 'index'])
            ->name('admin.purchaseorder.index');
        Route::get('/admin/purchaseorder/{id}', [AdminPurchaseOrderController::class, 'show'])
            ->name('admin.purchaseorder.show');
        Route::put('admin/purchase-orders/{id}/approve', [AdminPurchaseOrderController::class, 'approve'])
            ->name('admin.purchaseorder.approve');
        Route::put('admin/purchase-orders/{id}/reject', [AdminPurchaseOrderController::class, 'reject'])
            ->name('admin.purchaseorder.reject');

        // PROFORMA INVOICE
        Route::get('admin/quotation/{id}/proforma-invoice', [AdminProformaInvoiceController::class, 'index'])
            ->name('admin.proformainvoice.index');
        Route::get('admin/proforma-invoice/{id}', [AdminProformaInvoiceController::class, 'show'])
            ->name('admin.proformainvoice.show');
        Route::get('admin/proforma-invoice/create/{id}', [AdminProformaInvoiceController::class, 'create'])
            ->name('admin.proformainvoice.create');
        Route::post('admin/proforma-invoice/store/{id}', [AdminProformaInvoiceController::class, 'store'])
            ->name('admin.proformainvoice.store');
        Route::put('admin/proforma-invoice//payment-proofs/{id}', [AdminProformaInvoiceController::class, 'update'])
            ->name('admin.proformainvoice.paymentProof.update');
        ...
        Route::prefix('admin/career')->group(function () {
            ...
            Route::resource('positions', JobPositionController::class)->names([
                ...
                'store'   => 'admin.career.positions.store',
                'edit'    => 'admin.career.positions.edit',
                'update'  => 'admin.career.positions.update',
                'destroy' => 'admin.career.positions.destroy',
            ]);

            // APPLICATIONS
            Route::resource('applications', JobApplicationController::class)->names([
                'index'   => 'admin.career.applications.index',
                'show'    => 'admin.career.applications.show',
                'destroy' => 'admin.career.applications.destroy',
            ])->only(['index', 'show', 'destroy']);
        });

        // ABOUT US (ADMIN)
        Route::resource('admin/team', TeamMemberController::class)->names([
        ...
        Route::resource('admin/core', CoreValueController::class)->names([
            'index'   => 'admin.core.index',
            'create'  => 'admin.core.create',
            'store'   => 'admin.core.store',
            'edit'    => 'admin.core.edit',
            'update'  => 'admin.core.update',
            'destroy' => 'admin.core.destroy',
        ]);

        Route::resource('admin/process', ProcessStepController::class)->names([
            'index'   => 'admin.process.index',
            'create'  => 'admin.process.create',
            'store'   => 'admin.process.store',
            'edit'    => 'admin.process.edit',
            'update'  => 'admin.process.update',
            'destroy' => 'admin.process.destroy',
        ]);
